...
rochelle.setNickname(`✩ ${isim} '${yas}`)
  rochelle.addRole('757611324673884222'); // erkek 1
  rochelle.addRole('757611324673884222'); // erkek 1
  rochelle.addRole('757611324673884222'); // erkek 1
  rochelle.addRole('757611324673884222')
  rochelle.addRole('757611324673884222')

  rochelle.removeRole('757611325651157113'); // kadın 1
  rochelle.removeRole('757611325651157113')
  rochelle.removeRole('757611325651157113')

  rochelle.removeRole('757611325651157113') // kayıtsız 1
